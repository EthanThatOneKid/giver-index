...
It is part of the broader Agenticracy ecosystem (github.com/agenticracy/agenticracy-skill) — a set of open standards for responsible human-AI co-creation.
...
**Impact dimension (World Bank GDP per capita) — ~200 countries missing.** GDP per capita is a strong proxy for a society's structural capacity to do path-clearing work. Without it, countries like Singapore or UAE are invisible.
...
**Evidence-based: Pew reincarnation/belief data — ~40 countries covered.** Pew Research data on afterlife beliefs is a direct circular-archetype marker. Needs wiring.
...
The Agenticracy skill defines the broader context; this repo focuses on measurement.
